...
import { View, StyleSheet, ScrollView, Platform, useWindowDimensions, Alert } from 'react-native';
import { Card, Title, Text, Button, Switch, Divider, useTheme, TextInput } from 'react-native-paper';
...
export default function SettingsScreen({
  ...
  const [nextIdInput, setNextIdInput] = useState(nextIdFormatted || 'H66AAA00001');
        ...
        {isAdmin && (
          <Card style={[styles.card, { backgroundColor: theme.colors.surface }]}>
            <Card.Content>
              ...
              <Divider style={styles.divider} />
              <Text style={[styles.settingDescription, { color: theme.colors.onSurfaceVariant, marginBottom: 12 }]}>
